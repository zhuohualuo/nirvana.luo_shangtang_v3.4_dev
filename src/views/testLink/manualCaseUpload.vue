<template>
    <div class="body-contents">
        ...
        <hr style="height: 1px;border: none;background-color: #E6E6E6;margin-top: 20px;" v-if="dialogVisible"/>
...
<script>
  ...
  import { downloadManualCase } from '@/api/manualCase';
  ...
  export default {
    ...
    methods: {
      ...
      getUploadPath(){
        return rootPath + '/case/maintenance/upload';
      },
      ...
      getTemplate(){
        let self = this;
        downloadManualCase({is_template:true}).then(function (response) {
